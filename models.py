...
class diseaseModel(Base):
    __tablename__ = "tomatodisease_details"
    id=Column(Integer,primary_key=True,index=True)
    diseasename=Column(String,unique=True,index=True)
    diseasesympotomes=Column(String,unique=True,index=True)

class fertilizerModel(Base):
    __tablename__ = "Fertilizer_details"
    id=Column(Integer,primary_key=True,index=True)
    diseasename=Column(String,unique=True,index=True)
    fertilizername=Column(String,unique=True,index=True)
    fertilizeruses=Column(String,unique=True,index=True)
